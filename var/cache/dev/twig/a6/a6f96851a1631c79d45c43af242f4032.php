...
class __TwigTemplate_0700fd0f92834a063a43c7a27290f0c9 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "lieu/index.html.twig", 1);
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["Lieux"]) || array_key_exists("Lieux", $context) ? $context["Lieux"] : (function () { throw new RuntimeError('Variable "Lieux" does not exist.', 7, $this->source); })()));
...
{% block body %}
        ...
        <section class=\"lesLieux\">
            <div class=\"lieu\">
                ...
                <div class=\"lieu_details\">
                    <p>{{ Lieu.getLieu }}</p>
                    <br>
                    <p>La capacité de l'établissement est de : {{ Lieu.getCapacite }} places</p>
                    <br>
                    <p>L'adresse est au : {{ Lieu.getAdresse }} </p>
                </div>
            </div>
        </section>
        {% endfor %}
    {% endblock %}
{% endblock %}
", "lieu/index.html.twig", "/var/www/SAE301/templates/lieu/index.html.twig");
    }
}
